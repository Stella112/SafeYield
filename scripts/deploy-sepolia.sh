#!/usr/bin/env bash
# Deploy SafeYield to Sepolia and regenerate the frontend's TS ABIs.
#
# Required env vars:
...
FORGE_ARGS=(
  script/DeploySafeYield.s.sol:DeploySafeYield
...
echo "    packages/nextjs/contracts/SafeYield.ts."
